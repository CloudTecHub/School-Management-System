...
<br><br>
  ...
  <nav class="space-y-1 mt-4">
    ...
    <template x-for="[key, icon, label, links] of [
      ...
      ['subject', 'fa-book', 'Subject', [['view.php','View']]],
      ['test', 'fa-clipboard', 'Test', [['#','Add','openTestModal()'], ['view.php','View']]],
      ['attendance', 'fa-check', 'Attendance', [['attendance.php','Add Students'], ['view-attendance.php','Student Attendance'], ['check-in.php','My Attendance']]],
      ['notification', 'fa-bell', 'Notification', [['notification.php','View']]],
      ['reports', 'fa-ban', 'Reports', [['#','Report Student']]]
    ]" :key="key">
      <div>
